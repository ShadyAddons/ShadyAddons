...
public class HttpUtils {
     ...
     */
    public static CloseableHttpClient client = HttpClients.custom().setUserAgent("ShadyAddons/"+Shady.VERSION).addInterceptorFirst((HttpRequestInterceptor) (request, context) -> {
